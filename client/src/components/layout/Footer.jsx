    ...
    <footer className="pt-20 pb-10 transition-colors duration-300 border-t bg-slate-100 dark:bg-slate-950 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-800">
      <div className="container px-4 mx-auto">
        ...
        <div className="grid grid-cols-1 gap-12 mb-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            <h3 className="mb-6 font-bold text-slate-900 dark:text-white">Company</h3>
          ...
          <div>
            <h3 className="mb-6 font-bold text-slate-900 dark:text-white">Support</h3>
            <ul className="space-y-3 text-sm">
          ...
          <div>
            <h3 className="mb-6 font-bold text-slate-900 dark:text-white">Stay Updated</h3>
            <p className="mb-4 text-sm">Subscribe to our newsletter for latest updates.</p>
            <div className="flex gap-2">
              <Input 
                placeholder="Enter your email" 
                className="bg-white dark:bg-slate-900 border-slate-300 dark:border-slate-800 focus-visible:ring-primary"
              />
              <Button size="icon" className="text-white bg-primary hover:bg-primary/90">
        ...
        <div className="flex flex-col items-center justify-between gap-4 text-sm md:flex-row">
          ...
          <div className="flex gap-6">
            <a href="#" className="transition-colors hover:text-primary"><Facebook className="w-5 h-5" /></a>
            <a href="#" className="transition-colors hover:text-primary"><Twitter className="w-5 h-5" /></a>
            <a href="#" className="transition-colors hover:text-primary"><Instagram className="w-5 h-5" /></a>
            <a href="#" className="transition-colors hover:text-primary"><Linkedin className="w-5 h-5" /></a>
          </div>
        </div>
      </div>
    </footer>
